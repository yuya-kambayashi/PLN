...
namespace PLN.Commands
{
    ...
    public class RoomCreate : Command
    {
        public override string RegisteredName => "Room.Create";
        public override string Name => "Room Composite";
        ...
        public override async Task Apply(CADDocument doc, params string[] args)
        {
            ...
            Room newItem = new Room("Created", points);
